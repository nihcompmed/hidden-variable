...
The peformace of FEM is significantly better than other existing methods such as mean field approximations and Maximum Likelihood Estimation (MLE). Furthermore, FEM works approximately 100 faster than MLE.
